if (NOT GUROBI_FOUND)
    ...
    find_library(GUROBI_C_LIBRARY NAMES libgurobi100.so PATHS ${SEARCH_PATHS_FOR_LIBRARIES})
    find_library(GUROBI_CXX_LIBRARY_DEBUG NAMES libgurobi_c++.a PATHS ${SEARCH_PATHS_FOR_LIBRARIES})
    find_library(GUROBI_CXX_LIBRARY_RELEASE NAMES libgurobi_c++.a PATHS ${SEARCH_PATHS_FOR_LIBRARIES})
